...
/**
 * src/pages/ArchivePackDetailPage.tsx
 *
 * * パックアーカイブの詳細表示ページコンポーネント。
 * このページは、特定の $archiveId に基づくアーカイブパックデータ（PackBundle）をロードし、
 ...
 */
const ArchivePackDetailPage: React.FC = () => {
  ...
  return (
    <Box sx={{ p: 3, flexGrow: 1 }}>
      ...
      <Alert severity="info" sx={{ mb: 2 }}>
        **Archive ID:** {archiveId || '未指定'} - **現在のパス:** /archive/packs/{archiveId || '...'}
      </Alert>
        ...
        <Grid size={{xs:12,md:8}}>
          <Paper elevation={1} sx={{ p: 3 }}>
            ...
            <Typography color="text.secondary" sx={{ mb: 1 }}>
              このエリアに、アーカイブされた時点の収録カード一覧（PackBundleのCard群）が表示されます。
            </Typography>
...
export default ArchivePackDetailPage;